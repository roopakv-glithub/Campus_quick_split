...
AppSettings _appSettingsDeserialize(
  ...
  final object = AppSettings(
    primaryColorValue: reader.readLongOrNull(offsets[0]) ?? 0xFF2563EB,
    themeMode: reader.readStringOrNull(offsets[1]) ?? 'system',
    userEmail: reader.readStringOrNull(offsets[2]) ?? 'roopak.cs21@univ.edu',
    userName: reader.readStringOrNull(offsets[3]) ?? 'Roopak',
  );
  object.id = id;
  return object;
}
...
P _appSettingsDeserializeProp<P>(
  ...
  switch (propertyId) {
    case 0:
      return (reader.readLongOrNull(offset) ?? 0xFF2563EB) as P;
    case 1:
      return (reader.readStringOrNull(offset) ?? 'system') as P;
    case 2:
      return (reader.readStringOrNull(offset) ?? 'roopak.cs21@univ.edu') as P;
    case 3:
      return (reader.readStringOrNull(offset) ?? 'Roopak') as P;
    default:
...
extension AppSettingsQuerySortBy
  ...
  QueryBuilder<AppSettings, AppSettings, QAfterSortBy> sortByUserEmail() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'userEmail', Sort.asc);
    });
  }

  QueryBuilder<AppSettings, AppSettings, QAfterSortBy> sortByUserEmailDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension AppSettingsQuerySortThenBy
  ...
  QueryBuilder<AppSettings, AppSettings, QAfterSortBy> thenByUserEmail() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'userEmail', Sort.asc);
    });
  }

  QueryBuilder<AppSettings, AppSettings, QAfterSortBy> thenByUserEmailDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'userEmail', Sort.desc);
    });
  }
...
extension AppSettingsQueryWhereDistinct
  ...
  QueryBuilder<AppSettings, AppSettings, QDistinct> distinctByUserEmail(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension AppSettingsQueryProperty
  ...
  QueryBuilder<AppSettings, int, QQueryOperations> primaryColorValueProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppSettings, String, QQueryOperations> userEmailProperty() {
    return QueryBuilder.apply(this, (query) {
